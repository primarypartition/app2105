...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-2 mt-4">
            ...
            <p>
                <form action="{{route('download2', [$wallpaper->id])}}" method="post">
                    @csrf
            ...
            <p>               
                <form action="{{route('download1', [$wallpaper->id])}}" method="post">
                    @csrf
            ...
            <p>
                <form action="{{route('download3', [$wallpaper->id])}}" method="post">
                    @csrf
            ...
            <p>
                <form action="{{route('download4', [$wallpaper->id])}}" method="post">
                    @csrf
